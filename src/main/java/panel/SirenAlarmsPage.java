...
public class SirenAlarmsPage {
    ...
    public WebElement Disable_Siren_Is_Enabled;
    ...
    public WebElement Disable_Siren_Summary_disabled;
    ...
    public WebElement Disable_Siren_Summary_Installer_Mode;
    ...
    public WebElement Siren_Annunciation_Is_Disabled;
    @FindBy(xpath = "//android.widget.TextView[@text='Siren Annunciation is Enabled']")
    public WebElement Siren_Annunciation_Is_Enabled;
    ...
    public WebElement Fire_Verification_is_Disabled;
    @FindBy(xpath = "//android.widget.TextView[@text='Fire (Two Trip) Verification is Enabled']")
    public WebElement Fire_Verification_Is_Enabled;
    ...
    public WebElement Severe_Weather_Siren_Warning_Is_Enabled;
    @FindBy(xpath = "//android.widget.TextView[@text='Severe Weather Siren Warning is Disabled']")
    public WebElement Severe_Weather_Siren_Warning_Is_Disabled;
    ...
    public WebElement Dialer_Delay_Summary;
    ...
    public WebElement Siren_Timeout_Summary;
    ...
    public WebElement Water_Freeze_Siren_Is_Disabled;
    @FindBy(xpath = "//android.widget.TextView[@text='Water/Freeze Siren is Enabled']")
    public WebElement Water_Freeze_Siren_Is_Enabled;
    ...
    public WebElement Police_Panic_Is_Enabled;
    @FindBy(xpath = "//android.widget.TextView[@text='Police Panic is Disabled']")
    public WebElement Police_Panic_Is_Disabled;
    ...
    public WebElement Fire_Panic_Is_Enabled;
    @FindBy(xpath = "//android.widget.TextView[@text='Fire Panic is Disabled']")
    public WebElement Fire_Panic_Is_Disabled;
    ...
    public WebElement Auxiliary_Panic_Is_Enabled;
    @FindBy(xpath = "//android.widget.TextView[@text='Auxiliary Panic is Disabled']")
    public WebElement Auxiliary_Panic_Is_Disabled;
    ...
    public WebElement Allow_Master_Code_To_Access_Siren_and_Alarms_Is_Disabled;
    @FindBy(xpath = "//android.widget.TextView[@text='Allowing Master Code to access Siren and Alarms settings is Enabled']")
    public WebElement Allow_Master_Code_To_Access_Siren_and_Alarms_Is_Enabled;
}
