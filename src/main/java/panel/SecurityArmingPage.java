...
public class SecurityArmingPage {
    ...
    public WebElement Secure_Arming_Summary;
    ...
    public WebElement Refuse_Arming_When_Battery_Low_Summary;
    ...
    public WebElement Auto_Bypass_Summary;
    ...
    public WebElement Auto_Stay_Summary;
    ...
    public WebElement Arm_Stay_No_Delay_Summary;
    ...
    public WebElement Auto_Exit_Time_Extension_Summary;
    ...
    public WebElement Keyfob_Instant_Arming_Summary;
    ...
    public WebElement Keyfob_Alarm_Disarm_Is_Disabled;
    @FindBy(xpath = "//android.widget.TextView[@text='Allow Keyfob to disarm alarms setting is Enabled']")
    public WebElement Keyfob_Alarm_Disarm_Is_Enabled;
    ...
    public WebElement Keyfob_Disarming_Summary;
    ...
    public WebElement Allow_Master_Code_To_Access_Security_and_Arming_Is_Disabled;
    @FindBy(xpath = "//android.widget.TextView[@text='Allowing Master Code to access Security and Arming settings is Enabled']")
    public WebElement Allow_Master_Code_To_Access_Security_and_Arming_Is_Enabled;
