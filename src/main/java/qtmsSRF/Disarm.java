...
public class Disarm extends Setup {
    ...
    public Disarm() throws Exception { ConfigProps.init(); }
    ...
    public void Disb_21_DW8() throws Exception {
        ...
        sensors.primaryCall(door_window8, close);
        navigateToSettingsPage();
        Thread.sleep(1000);
        sett.STATUS.click();
        Thread.sleep(2000);
...
//    }
    ...
    public void Disb_23_DW9() throws Exception {
        ...
        addPrimaryCall(1, 9, 6619303, 1);
        navigateToSettingsPage();
        sett.STATUS.click();
        sensors.primaryCall(door_window9, open);
        TimeUnit.SECONDS.sleep(Long_Entry_Delay);
        Thread.sleep(2);
        sensors.primaryCall(door_window9, close);
        verifyInAlarm();
        enterDefaultUserCode();
        deleteFromPrimary(1);
        Thread.sleep(1000);
    ...
    public void Disb_24_DW8() throws Exception {
        ...
        addPrimaryCall(1, 8, 6619302, 1);
        Thread.sleep(2000);
        sensors.primaryCall(door_window8, tamper);
        Thread.sleep(4000);
        sensors.primaryCall(door_window8, close);
        verifyInAlarm();
        enterDefaultUserCode();
    ...
    public void Disb_25_DW9() throws Exception {
        ...
        addPrimaryCall(1, 9, 6619303, 1);
        Thread.sleep(2000);
        sensors.primaryCall(door_window9, tamper);
        Thread.sleep(4000);
        sensors.primaryCall(door_window9, close);
        verifyInAlarm();
        enterDefaultUserCode();
...
//    }
    ...
    public void Disb_39_DW14_DW16() throws Exception {
        ...
        addPrimaryCall(1, 14, 6619299, 1);
        addPrimaryCall(2, 16, 6619300, 1);
        Thread.sleep(1000);
        servcall.set_AUTO_BYPASS(01);
        Thread.sleep(2000);
        sensors.primaryCall(door_window14, tamper);
        Thread.sleep(2000);
        ARM_STAY();
        TimeUnit.SECONDS.sleep(Long_Exit_Delay/2);
        sensors.primaryCall(door_window16, tamper);
    ...
    public void Disb_41_KF1() throws Exception {
        ...
        addPrimaryCall(1, 1, 6619386, 102);
        Thread.sleep(1000);
    ...
    public void Disb_45_KF4() throws Exception {
        ...
        servcall.set_KEYFOB_NO_DELAY_disable();
        addPrimaryCall(1, 4, 6619387, 102);
        Thread.sleep(1000);
    ...
    public void Disb_47_KF6() throws Exception {
        ...
        addPrimaryCall(1, 6, 6619388, 102);
        Thread.sleep(2000);
    ...
    public void Disb_52_DW10() throws Exception {
        ...
        ARM_STAY();
        TimeUnit.SECONDS.sleep(Long_Exit_Delay/2);
        sensors.primaryCall(door_window10, tamper);
        TimeUnit.SECONDS.sleep(Long_Exit_Delay);
        verifyInAlarm();
        enterDefaultUserCode();
        deleteFromPrimary(1);
    ...
    public void Disb_53_DW12() throws Exception {
        ...
        ARM_STAY();
        TimeUnit.SECONDS.sleep(Long_Exit_Delay/2);
        sensors.primaryCall(door_window12, tamper);
        TimeUnit.SECONDS.sleep(Long_Exit_Delay);
        verifyInAlarm();
        enterDefaultUserCode();
        Thread.sleep(1000);
    ...
    public void Disb_54_DW13() throws Exception {
        ...
        ARM_STAY();
        TimeUnit.SECONDS.sleep(Long_Exit_Delay/2);
        sensors.primaryCall(door_window13, tamper);
        Thread.sleep(1000);
        verifyInAlarm();
        enterDefaultUserCode();
        Thread.sleep(1000);
...
//    }
    ...
    public void Disb_114_WAT() throws Exception {
        ...
        addPrimaryCall(1, 38, 7672224, 23);
        Thread.sleep(1000);
...
//    }
    ...
    public void Disb_127_SM_AUX_DW8_C0() throws Exception {
        ...
        HomePage home = PageFactory.initElements(driver, HomePage.class);
        logger.info("*Disb_126* System Disarm from alarm from keyfob 1");
        addPrimaryCall(1, 26, 6750242, 5);// 67 00 22
        addPrimaryCall(2, 6, 6361649, 21); //61 12 13
        addPrimaryCall(3, 8, 6619302, 1);
        addPrimaryCall(4, 34, 7667882, 6);
        adc.New_ADC_session(adc.getAccountId());
        Thread.sleep(10000);
        adc.driver1.findElement(By.partialLinkText("sensors")).click();
        Thread.sleep(10000);
   ...
   //     ADC_verification("//*[contains(text(), 'Fire Alarm')]", "//*[contains(text(), 'Auxiliary Pendant 2 (Sensor 2) BeClose Button Press')]");
    ...
    public void Disb_153_GB() throws Exception {
        ...
        addPrimaryCall(1, 13, 6750361, 19);
        Thread.sleep(2000);
