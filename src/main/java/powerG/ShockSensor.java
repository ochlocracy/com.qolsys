...
public class ShockSensor extends Setup {
    ...
    public void Shock_12() throws IOException, InterruptedException {
        ...
        TimeUnit.SECONDS.sleep(2);
        adc.driver1.findElement(By.xpath("//*[@id='ctl00_phBody_deviceList_ddlDevicesDdl']")).click();
        TimeUnit.SECONDS.sleep(2);

        Select sensetivity_lvl = new Select (adc.driver1.findElement(By.xpath("//*[@id='ctl00_phBody_udList_ddlNewValue']")));
        sensetivity_lvl.selectByVisibleText("High");
        TimeUnit.SECONDS.sleep(2);
